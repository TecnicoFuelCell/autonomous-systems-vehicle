...
/*********************************************************************************************************
** Function name:           clearRXnOVR
** Descriptions:            Limpa os bits RX0OVR/RX1OVR do EFLG. Estes são latched: o
**                          MCP2515 liga-os quando perde um frame por buffer cheio e só
**                          os baixa por software. Chamar depois de reportar o overflow,
**                          senão a flag fica presa e o diagnóstico repete-se para sempre.
*********************************************************************************************************/
