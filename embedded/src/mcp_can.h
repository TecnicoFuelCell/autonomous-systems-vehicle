 ...
 *********************************************************************************************************/
   ...
   private:
    ...
    // SPI read dos endereços dos flags. O read_register devolve uma byte com 8 flags
    ...
    void mcp2515_modifyRegister(const INT8U address,                    // Set specific bit(s) of a register
                                const INT8U mask, //quais bits quero modificar
                                const INT8U data); //quais os valores que quero passar aos bits
...
public:
    ...
    void  clearRXnOVR(void);                                            // Clear latched RX0OVR/RX1OVR flags
    INT8U errorCountRX(void); //lê REC                                          // Get error count
    INT8U errorCountTX(void); //lê TEC                                          // Get error count
